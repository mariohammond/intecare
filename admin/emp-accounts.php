    ...
    <div class="row justify-content-around">
      <div class="wrapper col">
        <div class="header text-center">
            <h3 class="pt-4">EMPLOYEE TIMESTUDY TRAINING ACCOUNTS</h3>
            ...
            foreach ($empList as $emp) {
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <a class='btn btn-success btn-sm btn-block' href='resend-email.php?id=$emp[0]&email=$emp[7]&period=$timePeriod' role='button'>Send</a>
                  </td>
              </tr>
              ";
            }
