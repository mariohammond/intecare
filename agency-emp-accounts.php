    ...
    <div class="row justify-content-around">
      <div class="wrapper col">
        <div class="header text-center">
            <h3 class="pt-4">EMPLOYEE TRAINING AND TIMESTUDY ACCOUNTS</h3>
            <h5 class="pb-4">Period: <?php echo $timePeriod; ?></h5>
            <div class="btn-group mb-4" role="group">
             
             <!-- <a class="btn btn-primary border" href="download-emp-list.php?period=<?php echo $timePeriod; ?>" role="button">Download List</a>-->
            ...
            foreach ($empList as $emp) {
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <a class='btn btn-success btn-sm btn-block' href='resend-email-agency.php?id=$emp[0]&email=$emp[7]&period=$timePeriod' role='button'>Send</a>
                  </td>
              </tr>
              ";
            }
