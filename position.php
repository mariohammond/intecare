<?php
    ...
    require "includes/positionInfo.inc.php";
        ...
        <div class="pt-4 employees-page-container container">
            ...
            <div class="row justify-content-between pb-2 pt-2">
                <div class="mb-3 col-sm-12 col-md-12 col-lg-4">
                    <select id="positionSelect2" class="form-control custom-select position-select">
                            <option value="0" selected>Filter By Position</option>
                            <?php include 'includes/optionsPositionTitle.inc.php'?>
                    </select>
                </div>
                <div class="mb-3 col-sm-12 col-md-12 col-lg-4">
                    <a href="./employees"><button id="employeeLink" type="button" class="form-control btn btn-primary">Search By Name</button></a>
                </div>
                <div class="custom-control custom-switch text-center align-middle pt-2 col-sm-12 col-md-12 col-lg-4">
                    <input type="checkbox" class="custom-control-input" id="inactiveSwitch">
                    <label class="custom-control-label" for="inactiveSwitch">Show Inactive</label>
                </div>
            </div>
            ...
            ?>
            <div class="row pb-3 emp-card <?php if ($active != 1) { echo 'inactive'; } ?>">
                <div class="col">
