    ...
    <div class="row justify-content-around">
      <div class="wrapper col">
        <div class="header text-center">
            <h3 class="pt-4">EMPLOYEE TRAINING PROGRESS</h3>
...
//var_dump($sql1); exit;
            ...
            foreach ($empList as $emp) {
                ...
                $sql2 = "SELECT pdfStart, pdfComplete FROM employee_training WHERE mhfrpid = '" . $emp[0] . "' AND timePeriod = '". $timePeriod . "'";
